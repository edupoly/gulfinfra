  ...
  return <section className="relative isolate overflow-hidden bg-[#07172c] bg-[linear-gradient(135deg,rgba(6,18,36,.94),rgba(11,31,58,.86)),url('https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=1800&q=85')] bg-cover bg-center px-4 py-16 text-white sm:px-6 sm:py-10 lg:px-8">
    <div className="mx-auto max-w-[1180px] text-center">
      ...
      <form onSubmit={(event) => {
        ...
        <Field icon={faMagnifyingGlass} label="What are you looking for?"><input name="keyword" placeholder="e.g. Contractors, Equipment" className="w-full bg-transparent text-sm font-medium text-slate-600 outline-none" /></Field>
        <Field icon={faLayerGroup} label="Category"><select name="category" className="w-full bg-transparent text-sm font-semibold text-slate-700 outline-none"><option value="contractors">Contractors</option><option value="projects">Projects & Tenders</option><option value="equipment">Equipment Marketplace</option><option value="materials">Construction Materials</option><option value="business">Business Opportunities</option></select></Field>
