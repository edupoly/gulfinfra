  ...
  return (
    <main className="bg-slate-50 px-4 py-10 sm:px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-9">
          <h2 className="text-2xl font-black text-[#0b1f3a]">{existing ? "Your quotation" : "Submit quotation"}</h2>
          {rfq.buyerId === user?.id ? <p className="mt-3 text-slate-600">This is your RFQ. Review its quotations from <Link href="/my-rfqs" className="font-bold text-blue-700">My RFQs</Link>.</p>
            : !user ? <p className="mt-3 text-slate-600"><Link href="/login" className="font-black text-blue-700">Sign in</Link> to submit a quotation.</p>
