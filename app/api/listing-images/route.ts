...
export async function POST(request: Request) {
  ...
  if (!draftId || !editToken || !(await draftExists(draftKind, draftId, tokenHash))) return Response.json({ error: "This draft could not be verified. Start a new listing." }, { status: 403 });
